...
<div class="row">
    <div class="col-12 text-center">
        ...
        <div class="mt-5">
            <a href="{{ route('attendance.report') }}" class="btn btn-primary btn-lg">Lihat Rekap Kehadiran Siswa</a>
            <a href="{{ route('staff.attendance.report') }}" class="btn btn-info btn-lg ms-2">Lihat Rekap Kehadiran Staff</a>
